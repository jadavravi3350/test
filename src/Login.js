...
function Login() {
    ...
    const handlesubmin = (e) => {
        ...
        if (email === "" || password === "") {
            ...
            fetch("https://lawyer-management-system-api.onrender.com/user/user-login", {
                method: "post",
            ...
            <div className="d-flex flex-wrap gap-4">
                ...
                <div className="col-12 col-lg-3 mb-5 mb-lg-0   row px-2 px-lg-4 mx-0">
                    ...
                    <div className="card-body py-5 px-md-5">
                        <h3 className="text-center my-4 fw-bold">User Login</h3>
                        <form onSubmit={handlesubmin}>
                            ...
                            <div data-mdb-input-init
                                ...
                                <i
                                    ...
                                    className={(showPassword) ? "ri-eye-off-line fontrightsilde fs-4" : "ri-eye-line fontrightsilde fs-4"}></i>

                                {/* <i
                                    className={showPassword ? "ri-eye-line fontrightsilde fs-4" : " ri-eye-off-line fontrightsilde fs-4"}
                                    onClick={() => setShowPassword(!showPassword)}
                            ...
                            <div className='text-center my-3'>
                                <Link to={"/ForgotPassword"} className='text-decoration-none fw-bold ' style={{ fontSize: "16px", color: "#0d75bf" }}>Forget Password?</Link>
                            </div>
                        ...
                        <p style={{ fontSize: "13px" }} className="my-5 text-center fw-bolder fs-6">Don't have an account? for User
                            <Link to={"/Regi"} className=' text-decoration-none'> Register .</Link></p>
                    </div>
                </div>
