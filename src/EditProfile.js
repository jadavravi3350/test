                ...
                <div className='col-12 col-lg-3 px-lg-3'>
                    ...
                    <div className='border'>
                        <div className=' text-center my-4'>
                            ...
                            <h4 className='fw-bold my-2' style={{ fontSize: "18px" }}>Kathryn Murphy</h4>
    ...
    return (<>
        ...
        <div>
            ...
            <Routes>
                ...
                <Route path='Complate' element={<Complate />}></Route>
                    ...
                    <div class="modal-content CheckAvailability">
                        ...
                        <div class="modal-body px-5 ">
                            ...
                            <div className=' d-flex justify-content-center gap-3'>
                                ...
                                <i class="ri-star-fill text-warning fs-1"></i>
                                <i class="ri-star-fill text-warning fs-1"></i>
                                <i class="ri-star-fill text-warning fs-1"></i>
                                <i class="ri-star-fill text-warning fs-1"></i>
                                <i class="ri-star-line text-warning fs-1"></i>
                ...
                <div className='col-12 col-lg-6 p-lg-3'>
                    <div className=' border p-4'>
                        ...
                        <div className="d-flex gap-2">
                            ...
                            <div className=' position-relative rounded-pill' style={{ background: "#f5f7fa", padding: "23px" }}>
